...
# CONET docs needed for a complete build
# CONET added 'ccnx_install' target to resolve some build issue (there are lines not useful for debug)
TOPSUBDIRS = csrc schema javasrc apps `cat local.subdirs 2>/dev/null || :`
